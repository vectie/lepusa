...
app-menu/window-menu and tray operations as executed, including macOS menu
...
`tray.onMenuItemClick`, while leaving non-macOS menu accelerator work explicitly
