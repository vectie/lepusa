...
visibility, and destroy. Remaining Linux/Windows tray, window-menu, menu
accelerator, and menu item action work is still reported as skipped until
concrete OS menu and status-item renderers land.
