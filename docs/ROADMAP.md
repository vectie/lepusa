...
- Implement or port WebView window creation for macOS, Windows, and Linux:
  ...
  operations, macOS menu accelerators, and macOS menu/tray item click dispatch
  reported as executed, with remaining Linux/Windows tray, window-menu,
  non-macOS menu accelerator, and non-macOS menu item action work reported as
...
- tray/menu/app shell: initial status icon/menu/app control contracts,
  ...
  for restart, macOS dock visibility, nested app-menu set/clear, and
  status-item tray handling, plus honest skipped execution reports for
  remaining Linux/Windows tray and window-menu renderer work exist
