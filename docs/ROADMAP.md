...
- Implement:
  ...
  - `lepusa bridge-loop`: feeds one source bridge message through the adapter loop and reports immediate scripts, async completions, and evaluation scripts.
  ...
  - `lepusa-runtime bridge-loop`: feeds one packaged bridge message through the adapter loop and reports immediate scripts, async completions, and evaluation scripts.
